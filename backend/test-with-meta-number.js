// Test real WhatsApp message sending with test number
...
async function testRealWhatsAppSending() {
  try {
    ...
    const testPhoneNumber = '15551872451'; // Número de prueba de Meta
    
    console.log(`📤 Enviando mensaje: "${testMessage}"`);
    console.log(`📱 A número de prueba: ${testPhoneNumber}`);
    ...
    if (response.ok) {
      ...
      console.log('📱 El mensaje se envió al número de prueba de Meta');
      console.log('💡 Ahora puedes configurar esto en el dashboard');
    } else {
